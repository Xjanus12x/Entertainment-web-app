...
import { TVShowDetails } from "../models/MediaDetails";
...
const MovieDescriptionPage = () => {
  ...
  const safeFirstAirYear =
    mediaDetails && isValidDate(first_air_date) ? first_air_date : "N/A";
  const safeLastAirYear =
    mediaDetails && isValidDate(last_air_date) ? last_air_date : "N/A";
  return (
      ...
      <article className="gap-6 text-crispWhite md:grid md:grid-cols-2">
        ...
        <div className="mt-4 space-y-4">
          ...
          <ul className="flex flex-wrap items-center justify-between text-center md:justify-start md:gap-10">
            ...
            <li>
              <p className="font-semibold text-slateBlue">First Air</p>
              <p className="text-lg font-semibold"> {safeFirstAirYear}</p>
            </li>
            <li>
              <p className="font-semibold text-slateBlue">Last Air</p>
              <p className="text-lg font-semibold">{safeLastAirYear}</p>
            </li>
            <li>
